...
28 stories · 8 epics · 87 FRs couverts
...
| [1.4](story-1.4-terminer-tache.md) | Marquer une tâche comme terminée *(révisée — suppression .archivee)* | FR28 | — |
...
| [2.7](story-2.7-refonte-dashboard.md) | Refonte Dashboard — Hero Task Card et Explorer enrichi *(post-Epic 2)* | FR1, FR22, FR24, FR29 | NFR-P3 |
...
| [7.5](story-7.5-reordonnancement-todos.md) | Réordonnancement manuel des ToDos par glisser-déposer | FR87 | NFR-U1, NFR-U6 |
...
```
1.1 → 1.2 → 1.3 → 1.4 (révisée)
              ↓
2.1 → 2.2 → 2.3 → 2.4 → 2.5 → 2.6 → 2.7 (refonte dashboard)
                                           ↓
                              3.1 → 3.2 → 3.3
                                           ↓
                              4.1 → 4.2 → 4.3 → 4.4
...
- Story 1.4 (révisée) : à implémenter AVANT story 2.7 (le filtre Actives/Terminées de TacheListView en dépend)
